...
output_requirements:
  summary:
    ...
    cfrp_relevance_check: "記事にCFRP、炭素繊維、複合材料、複合素材、carbon fiber、composite材料に関する言及が全くない、またはほとんど触れられていない場合のみ、要約の最初に「本記事はCFRP、複合素材についての言及はありません（少ないです）。」を記載してください。1〜2回でも関連用語が使われている場合は、この警告は不要です。"
